      ...
      <div className="content-box">
        <div className="max-w-[1280px] mx-auto px-2 ">
          <div className="service-grid">
            ...
            <div className="service-extensions aos-init aos-animate" data-aos="fade-right">
            ...
            <div className="service-roofing aos-init aos-animate" data-aos="fade-up">
              <div className="service-item">
                <div className="service-item-icon">
            ...
            <div className="service-driveways aos-init aos-animate" data-aos="fade-left">
              <div className="service-item">
                <div className="service-item-icon">
            ...
            <div className="service-electrical-work aos-init aos-animate" data-aos="fade-right">
              <div className="service-item">
                <div className="service-item-icon">
            ...
            <div className="service-plumbig aos-init aos-animate" data-aos="fade-down">
              <div className="service-item">
                <div className="service-item-icon">
            ...
            <div className="service-heating aos-init aos-animate" data-aos="fade-left">
              <div className="service-item">
                <div className="service-item-icon">
                ...
                <div className="service-item-desc">
                  <p>All types of heating services and instalations.</p>
                </div>
              </div>
            </div>
